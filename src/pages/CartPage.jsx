      ...
      <TableBody> 
        {myCart.products.map((item)=>(
          ...
          sx={{ '&:last-child td, &:last-child th':{border:0}}}>
            ...
            <TableCell align='center'>
              <input min={1} onChange={(e)=>changeCountProductInCart(item.product.id,e.target.value)} type="number" value={item.count}/>
          </TableCell>
        ...
        <TableFooter>
          <TableRow>
            <TableCell align='center'><h2>{myCart.totalPrice}сом</h2></TableCell>
            </TableRow>
            </TableFooter>
            </Table>
            </TableContainer>
